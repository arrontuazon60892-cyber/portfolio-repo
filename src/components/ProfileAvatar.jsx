  ...
  return (
    ...
    >
      <motion.div
        ...
        style={{
          background: "radial-gradient(circle at 50% 40%, rgba(37, 99, 235, 0.18), transparent 34%), radial-gradient(circle at 50% 55%, rgba(15, 23, 42, 0.82), rgba(2, 6, 23, 0.22) 62%, transparent 100%)",
          filter: "blur(14px)",
        }}
      />
